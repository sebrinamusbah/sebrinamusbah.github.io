...
function Hero() {
  ...
  return (
    <section
      id="home"
      className=" relative z-10 bg-transparent min-h-screen flex items-center justify-center particle-bg bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800"
    >
